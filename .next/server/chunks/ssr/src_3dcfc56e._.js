...
function UserDashboard() {
    ...
    const fetchMonthlySubscription = async ()=>{
        try {
            ...
            console.error(err);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error("Error fetching unpaid subscriptions.");
        }
    };
        ...
        try {
            ...
            if (result.data && result.data.length > 0) {
                const paidSubs = result.data.map((sub)=>({
                        paidForMonth: sub?.paidForMonth,
                        paidForDueDate: sub?.paidForDueDate,
                        amount: sub?.subscriptionId?.amount,
                        gst: sub?.gst,
            ...
            console.error(err);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error("Error fetching paid subscriptions.");
        }
    };
...
//# sourceMappingURL=src_3dcfc56e._.js.map