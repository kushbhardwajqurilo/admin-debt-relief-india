...
class Virtualizer {
    constructor(opts){
        ...
        this.getOffsetForAlignment = function(toOffset, align) {
            let itemSize = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 0;
        ...
        this.getOffsetForIndex = function(index) {
            ...
            return [
                _this.getOffsetForAlignment(toOffset, align, item.size),
                align
            ];
        };
        ...
        this.scrollToIndex = function(index) {
            ...
            const scheduleRetry = (align)=>{
                ...
                if (attempts < maxAttempts) {
                    if (("TURBOPACK compile-time value", "development") !== "production" && _this.options.debug) {
                        console.info("Schedule retry", attempts, maxAttempts);
                    }
                    _this.targetWindow.requestAnimationFrame(()=>tryScroll(align));
                } else {
                    console.warn("Failed to scroll to index ".concat(index, " after ").concat(maxAttempts, " attempts."));
                }
            };
        ...
        this.getTotalSize = ()=>{
            ...
            if (measurements.length === 0) {
                ...
                var _ref;
                end = (_ref = (_a = measurements[measurements.length - 1]) == null ? void 0 : _a.end) !== null && _ref !== void 0 ? _ref : 0;
            } else {
...
function calculateRange(param) {
    let { measurements, outerSize, scrollOffset, lanes } = param;
...
//# sourceMappingURL=node_modules_f1c6ffab._.js.map